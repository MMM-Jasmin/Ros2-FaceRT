...
def generate_launch_description():
    ...
    topic_pub_launch_arg = DeclareLaunchArgument(
        "topic_pub", default_value=TextSubstitution(text="emotion_id"))
    ...
    eng_onnx_path_launch_arg = DeclareLaunchArgument(
        "eng_onnx_path", default_value=TextSubstitution(text="/opt/dev/DL_Models/face_rec/model_emotion/enet_b2_7.onnx"))
    eng_save_path_launch_arg = DeclareLaunchArgument(
        "eng_save_path", default_value=TextSubstitution(text="/opt/dev/DL_Models/face_rec/model_emotion/emotion.rt"))
